...
Linux privilege-escalation workflow page with enumeration, SUID/capabilities, cron/systemd, stored credentials, Docker/NFS, kernel checks, and exploitation helpers.
Duplicate checklist material was collapsed only when the content was materially the same.
