...
> Source: `01101100-C0D3X-00110110.md` → `General Checklist Before Starting`
...
> Source: `01101100-C0D3X-00110110.md` → `PING SWEEP?  (edit subnet)`
...
> Source: `01101100-C0D3X-00110110.md` → `EXTRACT LIVE IPS? (→ online)`
...
> Source: `01101100-C0D3X-00110110.md` → `TOP‑100 PORT SCAN?`
...
> Source: `01101100-C0D3X-00110110.md` → `FULL TCP (optional)?`
...
> Source: `01101100-C0D3X-00110110.md` → `CLEAR CMD RUNMRU? > Enumeration > Autorecon`
...
> Source: `01101100-C0D3X-00110110.md` → `CLEAR CMD RUNMRU? > Enumeration > nmap`
