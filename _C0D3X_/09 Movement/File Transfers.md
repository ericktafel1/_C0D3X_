...
Practical upload/download patterns, quick SMB serving, and encoded transfer helpers.
Keep this page separate from payload generation so you can find transfer mechanics quickly under pressure.

## General Transfer Commands
