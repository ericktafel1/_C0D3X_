# Client-Side and Office Payload Delivery

Client-side delivery notes that were retained because they are still useful during real assessments when phishing, macro delivery,
MOTW bypass behavior, or library-file abuse is in scope.
