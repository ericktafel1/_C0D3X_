# Host Enumeration and Access

Windows host-focused triage after initial access: process/user context, services, files, remote access, RunAs, token use, and proof collection.
Domain-wide AD theory was intentionally kept out of this page unless the command is still primarily host-focused.
